...
When you first run Collect, it is set to download forms from [https://demo.getapp.org/](https://demo.getapp.org/), the demo server. You can sometimes verify your changes with those forms but it can also be helpful to put a specific test form on your device. Here are some options for that:
