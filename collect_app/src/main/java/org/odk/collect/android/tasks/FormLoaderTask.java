            ...
            if (instanceXml.exists()) {
                ...
                try {
                    ...
                    if (usedSavepoint && !(e.getCause() instanceof XPathTypeMismatchException)) {
                        ...
                        throw new RuntimeException("An unknown error has occurred. Please ask your project leadership to email support@getapp.org with information about this form."
                            + "\n\n" + e.getMessage());
                    }
                }
            } else {
